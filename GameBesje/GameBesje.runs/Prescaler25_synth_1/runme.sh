...
HD_PWD='D:/PROGHProjecten/PROGH2/Project_Besje/GameBesje/GameBesje.runs/Prescaler25_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Prescaler25.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Prescaler25.tcl
