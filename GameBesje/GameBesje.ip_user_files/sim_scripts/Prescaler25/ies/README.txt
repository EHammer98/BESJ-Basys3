...
#
# Generated by export_simulation on Sun Mar 06 14:37:14 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './Prescaler25.sh' script.

./Prescaler25.sh -reset_run
...
./Prescaler25.sh -noclean_files

For more information on the script, please type './Prescaler25.sh -help'.
